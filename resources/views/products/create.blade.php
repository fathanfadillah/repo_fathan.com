  ...
  <div class="row">
    <div class="col">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm">
                <input type="text" name="storage" class="form-control" id="storage" placeholder="gb" value="{{old('storage')}}">
                @error('storage')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm">
                <input type="text" name="harga" class="form-control" id="harga" placeholder="rupiah" value="{{old('harga')}}">
                @error('harga')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="col text-center">
                  <!-- <button type="submit" class="btn btn-danger rounded-right col-md-5 ">TAMBAH</button> -->
                  <button class="btn btn-outline-danger col-md-5" type="submit">
							      ADD
						      </button>
              </div>
          </form>    
